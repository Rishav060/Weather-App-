...
const searchCitySection = document.querySelector('.srch-city')
...
const apiKey = '1c60acb7bbf12247800d4312c700f59d'
...
function updateForecastItems(weatherData) {
  ...
  const  forecastItems = `
      <div class="forecast-items"> 
          ...
          <img class="forecast-item-img" src="Assets/${getWeatherIcon(id)}">
